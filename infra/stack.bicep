...
resource webSiteConnectionStrings 'Microsoft.Web/sites/config@2020-12-01' = {
  ...
  properties: {
    ...
    Images: {
      value: concat('DefaultEndpointsProtocol=https;AccountName=', storageAccountName, ';AccountKey=',listKeys(resourceId('Microsoft.Storage/storageAccounts', storageAccountName), '2021-02-01').keys[0].value,';EndpointSuffix=core.windows.net')
      type: 'Custom'
    }
  }
}
